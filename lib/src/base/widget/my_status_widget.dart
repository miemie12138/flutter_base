...
import 'package:flutter_base/src/base/widget/my_flower_loading.dart';
...
// 状态值
mixin class MyStatusValueMixin {
        ...
        switch (value) {
          case MyStatusEnum.loading:
            return GestureDetector(
              ...
              child: loading?.call() ?? widget?.call(value) ?? const Center(child: FlowerLoadingIndicator()),
            );
